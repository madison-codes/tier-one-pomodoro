...
function initiateNextTimer() {
  // debugger;
  if (Pomodoro.pomodoros[0].session === 'work') { Pomodoro.createBreakTimer(setCustomBreak()); }
  if (Pomodoro.pomodoros[0].session === 'rest') { Pomodoro.createFocusTimer(setCustomFocus()); }
}
