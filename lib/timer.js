...
Timer.prototype.setDefault = function(){
  console.log('butt')
  if (this.type === break) { return this.duration = 5 * 60 * 1000; }
  if (this.type === work) { return this.duration = 25 * 60 * 1000; }
};
...
Timer.prototype.get = function(){
  var retrievedObject = JSON.parse(localStorage.getItem('timer'));
